...
## Programmatism and Blurring: A Typology of Party Appeals

<u>Abstract</u>: This paper examines the relationship between programmatic competition—the extent to which parties appeal to voters through policy platforms (Kitschelt et al. 2010)—and positional blurring—parties' strategic ambiguity about their policy positions (Rovny 2012)—in contemporary Latin America. Existing research suggests these strategies should be negatively associated: parties that compete programmatically are expected to present clear positions, while those relying on alternative linkages should blur. Yet prior work documents that programmatic parties sometimes blur strategically, and it is equally possible that non-programmatic parties do not blur at all. I develop a typology that treats programmatism and blurring as separable dimensions of party appeals. The resulting typology distinguishes four ideal types: programmatists, who compete on policy and stake out clear positions; hedgers, who compete on policy while deliberately obscuring where they stand; accommodators, who do neither; and anchored/diminished, who do not blur despite the absence of a program. Analyzing expert survey data on eighteen Latin American countries, I apply this typology and show that all four types of party appeals are populated, demonstrating the empirical validity of the framework. 
...
## Irregularity Accusations, Social Norms, and Electoral Perceptions in Peru
